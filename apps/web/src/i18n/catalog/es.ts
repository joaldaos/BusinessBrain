...
export const es = {
  ...
  'insight.history.neverChanged': 'No ha cambiado desde que se detectó, el {date}.',
  'insight.history.changedTimes': 'Ha cambiado {count} vez/veces desde que se detectó.',
  'insight.history.lastChange': 'La última, el {date}:',
