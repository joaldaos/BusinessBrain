 ...
 *
 * Subfases 5.1-5.4: definición, ciclo de vida, gate de políticas, preparación del turno de
 * ejecución y memoria privada de cada usuario. Consume el Understanding Engine y el Knowledge Engine por sus contratos
